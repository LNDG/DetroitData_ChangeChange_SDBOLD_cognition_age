...
a=scatter((DimPerc_spatial_BSRmask(:,2)-DimPerc_spatial_BSRmask(:,1)),BSRmask_usc,100,[0 0 1],'filled','MarkerEdgeColor',[1 1 1])
a.MarkerFaceAlpha = .5;
hline=refline;
hline.LineWidth=1;
hline.Color=[0 0 0];
...
a=scatter((DimPerc_spatial_BSRmask(:,2)-DimPerc_spatial_BSRmask(:,1)),vsc,100,[0 0 1],'filled','MarkerEdgeColor',[1 1 1])
ylim([-7,6])
a.MarkerFaceAlpha = .5;
hline=refline;
hline.LineWidth=1;
...
DimxUSC_corr=corr(DimPerc_spatial_BSRmask(:,2)-DimPerc_spatial_BSRmask(:,1),BSRmask_usc);
DimxVSC_corr=corr(DimPerc_spatial_BSRmask(:,2)-DimPerc_spatial_BSRmask(:,1),vsc);

DimxUSC_corr_rho=corr(DimPerc_spatial_BSRmask(:,2)-DimPerc_spatial_BSRmask(:,1),BSRmask_usc,'type','Spearman');
DimxVSC_corr_rho=corr(DimPerc_spatial_BSRmask(:,2)-DimPerc_spatial_BSRmask(:,1),vsc,'type','Spearman');
save('Dim_USC_VSC_corrs.mat','DimxUSC_corr_rho','DimxVSC_corr_rho','DimxUSC_corr','DimxVSC_corr')
